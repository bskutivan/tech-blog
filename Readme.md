# Tech Blog
  ![Github licence]MIT
  ## Description
  This project allows users to create accounts, create blog posts, and comment on other posts.
  ## Table of Contents
...
THEN I am automatically signed out of the site </br>
  ...
  ## Contributing
  Any improvements to refactoring efforts is always appreciated.
  ## Tests
  None as of yet
  ## Questions
